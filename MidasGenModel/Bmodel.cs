    ...
    public class Bmodel : Object
    {
        ...
        public static Point3d RotNodebyAxis(Point3d pt_original, Point3d pt1_Axis, Point3d pt2_Axis, double A)
        {
            ...
            if (vf.CrossProduct(new Vector3 (1,0,0)).Equals(new Vector3(0,0,0))||
                ...
                Math.Abs( vf.Angle(new Vector3(1, 0, 0))-Math.PI) <= 0.00001)
            {
...
'{12}','{13}','{14}',{15},{16})",
    ...
    /// </summary>
    [Serializable]
    public class Copy1OfBmodel : Object
    {
        #region 成员
        /// <summary>
        /// 单位系统
...
'{12}','{13}','{14}',{15},{16})",
    ...
    /// </summary>
    [Serializable]
    public class CopyOfBmodel : Object
    {
        #region 成员
        /// <summary>
        /// 单位系统
