...
//-----------------------------------------------------------------------------
    public class PermutationAndCombination<T>
    {
        ...
        private static void GetCombination(ref List<T[]> list, T[] t, int n, int m, int[] b)
        {
            //for (int i = n; i >= m; i--)
            //{
            //    b[m - 1] = i - 1;
            ...
            //    }
            //}
            for (int i = n; i <= t.Length - m; i++)
            {
                b[b.Length - m] = i;
                if (m > 1)
                {
                    GetCombination(ref list, t, i + 1, m - 1, b);
                }
                else
                {
                    if (list == null)
